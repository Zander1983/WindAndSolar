        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
            <img
              ...
              style={{ marginRight: '10px' }}
            />
            <h3 style={{ color: '#616161', margin: 0 }}>Carbon-Powered Electricity <Tooltip text="Enter the current amount of fossil fuel powered electricity the country generates in a year" /></h3> {/* Dark gray text */}
